...
const Card = (props) => {
    ...
    const { id, name, group, path, callback, label, details, type, value, field } = props;
    ...
    */
    ...
    return (
        <div 
            className={`card card--${value === true ? "selected" : "default"}`} 
            onClick={() => dispatch ({
                type: callback,
                payload: {
                    name: name,
            ...
            <div className="card__content">            
                <label 
                    className={`card__label card__label--${value == true ? "selected" : "default"} `} 
                    for={name}>
                    {label}
                </label>
                <p 
                    className={`card__details card__details--${value == true ? "selected" : "default"} `}>
                    {details}
                </p>
                {field === true
                    ?   <input 
